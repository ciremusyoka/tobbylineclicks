...
describe('decorator:localStorage', () => {
	...
	beforeEachProviders(() => [TestComponent, LocalStorageService]);

	it('should keep the default value', inject([TestComponent], (component) => {
		expect(component.local_key1).toEqual('default value');
	}));

	it('should update the local_key1 value by the wstorage service', inject([TestComponent, LocalStorageService], (component, localS) => {
	...
	it('should update the local_key1 value by the decorator', inject([TestComponent, LocalStorageService], (component, localS) => {
	...
	it('should update the local_key2 value by the wstorage service', inject([TestComponent, LocalStorageService], (component, localS) => {
	...
	it('should update the local_key2 value by the decorator', inject([TestComponent, LocalStorageService], (component, localS) => {
